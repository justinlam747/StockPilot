...
ActiveRecord::Schema[7.2].define(version: 2026_03_22_045238) do
  ...
  create_table "alerts", force: :cascade do |t|
    ...
    t.index ["shop_id", "dismissed"], name: "index_alerts_on_shop_id_and_dismissed"
    t.index ["shop_id", "variant_id", "triggered_at"], name: "idx_alerts_variant_day"
  ...
  create_table "inventory_snapshots", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: nil, default: -> { "now()" }, null: false
    t.index ["shop_id", "snapshotted_at"], name: "idx_snapshots_shop_time"
    t.index ["shop_id"], name: "index_inventory_snapshots_on_shop_id"
    t.index ["variant_id", "snapshotted_at"], name: "idx_snapshots_variant_time", order: { snapshotted_at: :desc }
