...
# Legacy compatibility model for the old low-stock product surface.
# The active Catalog Audit flow computes issues in Catalog::AuditService and
# should not add new behavior here.
